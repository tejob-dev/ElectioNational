<x-app-layout>
    <x-slot name="stylec">
        ...
        <style>
            ...
            #table1 > tbody > tr > td:nth-child(2), #table1 > tbody > tr > td:nth-child(4) {
            ...
            #table1 > tbody > tr > td:nth-child(9), #table1 > tbody > tr > td:nth-child(8) {
            ...
            #table1 > tbody > tr > td:nth-child(10), #table1 > tbody > tr > td:nth-child(11) {
            ...
            #table1 > tbody > tr > td:nth-child(12) {
            ...
            $(function() {
                ...
                var table = $('#table1').DataTable({
                    ...
                    drawCallback: function( settings ) {
                        ...
                        $('<tr><td class="sorting_1">TOTAL GENERALE</td><td>'+listOfSum[0]+'</td><td>'+listOfSum[1]+'</td><td>'+listOfSum[2]+'</td><td>'+listOfSum[3]+'</td><td>'+listOfSum[4]+'</td><td>'+listOfSum[5]+'</td><td>'+listOfSum[6]+'</td><td>'+listOfSum[7]+'</td><td>'+listOfSum[8]+'</td><td>'+listOfSum[9]+'</td><td>'+listOfSum[10]+'</td></tr>')
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('recens.districts.list', ['single'=>0]) }}",
