    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @php
                ...
                if( preg_match("/operateur/i", $url) ){
                    echo "Liste des opérateurs";
                }else{
                        ...
                        <tbody class="text-gray-600">
                            @forelse($users as $user)
                                ...
                                <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-left">
                                            {{ $user->date_naiss ? Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $user->date_naiss)->format('d/m/Y'): '-' }}
                                        </td>
                                        <td class="px-4 py-3 text-left">
                                            {{ optional($user->commune)->libel ?? '-' }}
                                        </td>
                                        <!-- <td class="px-4 py-3 text-left">
                                ...
                                @else
                                    @if(auth()->user()->hasPermissionTo('can-set-only-rule-ops'))
                                        @if ( sizeof($user->roles) == 0 || $user->hasRole("Opérateur de section") )
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-3 text-left">
                                                {{ $user->name ?? '-' }}
                                            </td>
